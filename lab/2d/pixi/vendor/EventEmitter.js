...
EventEmitter.prototype.emit = function emit(event, a1, a2, a3, a4, a5) {
  ...
  console.log('evt', evt, 'prefix', prefix);
  console.log('typeof _events', typeof this._events, this._events);
  ...
  console.log('typeof listeners', typeof listeners, listeners);
...
EventEmitter.prototype.on = function on(event, fn, context) {
  console.log('-------------------------------------------------------');
  console.log(this._eventsCount, 'EventEmitter.on(', event, fn, context, ')');
  console.log('-------------------------------------------------------');
