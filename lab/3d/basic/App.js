...
export default class App {
  constructor() {
    ...
    this.pixi = new PIXI.Application(width, height, {
      ...
      // view: window.document.getElementById('stage'),
    }, true);
  ...
  initializeGUI() {
    ...
    settings.createTriangle = this.createTriangle.bind(this);
    settings.createRectangle = this.createRectangle.bind(this);
    settings.createCube = this.createCube.bind(this);
    settings.createSphere = this.createSphere.bind(this);
    settings.createOctahedron = this.createOctahedron.bind(this);
    settings.createAxis = this.createAxis.bind(this);
    settings.createAxisLine = this.createAxisLine.bind(this);
    settings.createCoordinateBox = this.createCoordinateBox.bind(this);
    settings.zoomIn = this.zoomIn.bind(this);
    settings.zoomOut = this.zoomOut.bind(this);
    settings.reset = this.reset.bind(this);
    settings.clear = this.clear.bind(this);

    gui.add(settings, 'createTriangle');
    gui.add(settings, 'createRectangle');
    gui.add(settings, 'createCube');
    gui.add(settings, 'createSphere');
    gui.add(settings, 'createOctahedron');
    gui.add(settings, 'createAxis');
    gui.add(settings, 'createAxisLine');
    gui.add(settings, 'createCoordinateBox');
    gui.add(settings, 'zoomIn');
    gui.add(settings, 'zoomOut');
