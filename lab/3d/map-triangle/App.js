...
export default class App {
  ...
  initialize() {
    ...
    destinationCanvas.style.top = 130 + 'px';
  ...
  initializeGUI() {
    ...
    settings.createImage = this.createImage.bind(this);
    settings.createCube = this.createCube.bind(this);

    this.gui.add(settings, 'createTriangle');
    this.gui.add(settings, 'createImage');
    this.gui.add(settings, 'createCube');
  }
