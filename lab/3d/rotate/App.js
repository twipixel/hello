...
export default class App {
  ...
  initializeGUI() {
    ...
    settings.createSurface = this.createSurface.bind(this);
    settings.createCoordinate = this.createCoordinate.bind(this);
    settings.rotateX = this.rotateX.bind(this);
    settings.rotateY = this.rotateY.bind(this);
    settings.rotateZ = this.rotateZ.bind(this);

    gui.add(settings, 'createTriangle');
    gui.add(settings, 'createRectangle');
    gui.add(settings, 'createCube');
    gui.add(settings, 'createSurface');
    gui.add(settings, 'createCoordinate');
